...
// Implements shell, skill state tools, ask_a_friend, session review extraction, and
// block/file editing with OpenAI tool-calling format, multi-call per turn support,
